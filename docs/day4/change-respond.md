...
HomeSphere wants to measure whether campaigns lead to sales. A new marketing feed contains campaign ID, customer ID, channel, clicks, and campaign cost.

### Group B - Device reliability

The product team wants to combine IoT fault events with product and support data to identify unreliable devices and firmware versions.

### Group C - Automated daily processing

Finance needs the pipeline to run every morning without manual file uploads or notebook execution. Someone must be notified if validation fails.

### Group D - New supplier feed
